...
local DiscordLib = loadstring(game:HttpGet"https://raw.githubusercontent.com/knowpimlisy/MainGUI/main/GuiKx.lua")()

local win = DiscordLib:Window("Know Hub ")
...
if toClipboard then
  toClipboard('https://discord.gg/Ncdt4FNX38')
else
end
...
btns:Button("Owner + Scripter", function()
  if setclipboard then 
      setclipboard("know.pimlisy#1443")
  elseif toClipboard then 
      toClipboard("know.pimlisy#1443")
  end
end)